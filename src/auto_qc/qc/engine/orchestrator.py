...
from auto_qc.qc.rules.rules import load_rule_sets, validate_rule_sets
...
from auto_qc.qc.rules.report import write_report, verify_report_exists
from auto_qc.qc.rules.merger import merge_to_wide_rows

from auto_qc.qc.engine.validator import (
    validate_batches,
    validate_single_rule_output,
)
from auto_qc.qc.engine.worker import call_llm_with_retry, extract_json_str, reset_token_stats, get_token_stats
from auto_qc.qc.engine.progress import create_progress, load_progress, save_progress
...
async def run_qc(
    ...
    # ─── Step 1: 环境检查 ───
    print("[Step 1] 环境检查...")
    from auto_qc.qc.rules.report import HEADER_FONT
    print("  [OK] 依赖就绪")
