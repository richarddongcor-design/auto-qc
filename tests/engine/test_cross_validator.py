from auto_qc.qc.engine.cross_validator import fixed_sample, compare_results, _build_adjudication_prompt
...
async def test_adjudicate_no_disagreement():
    ...
    from auto_qc.qc.engine.cross_validator import adjudicate
    original = [
